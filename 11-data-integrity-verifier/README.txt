...
Project Overview
This command-line tool, written in Java, demonstrates a core cybersecurity principle: data integrity. 
It uses the SHA-256 cryptographic hashing algorithm to generate a unique digital fingerprint for any file. This allows for the verification 
of a file's integrity, ensuring that it has not been altered or tampered with. 
This is a critical function in cybersecurity for preventing unauthorized file modification, detecting malware, and ensuring the
