...
| 04/06 ~18:31 | ISM retention policy `retention` created → 30d delete on wazuh-alerts-* / wazuh-archives-* |
...
- [x] ISM 30-day retention policy applied to wazuh-alerts-* and wazuh-archives-*
...
*Report authored by: [Your Name] | April 6, 2026*  
*Environment: Personal Home Lab — aspida-security project*
